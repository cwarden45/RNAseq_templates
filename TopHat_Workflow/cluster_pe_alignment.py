...
for file in fileResults:
	...
	if result:
		...
		if (sample not in finishedSamples):
			...
			#could also add insert size with -r parameter (might be helpful with fragment >300 bp and/or reads shorter than 50 bp)
			text = "tophat -o " + outputSubfolder + " -p " + threads + " --no-coverage-search --library-type " + tophatStrand + " " + ref + " " + read1 + " " + read2 + "\n" 
			outHandle.write(text)
