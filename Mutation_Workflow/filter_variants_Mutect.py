...
summary_file = "MuTect_variant_counts.txt"
...
for mutectPrefix in mutectPrefixes:
	...
	outputSubfolder = resultFolder +"/" + mutectPrefix
	command = "mkdir " + outputSubfolder
	os.system(command)
	
	vcfFull = mutectPrefix + ".vcf"																			
	vcfFlagFilter = outputSubfolder + "/" + mutectPrefix + ".pass.vcf"
	...
	text = mutectPrefix + "\t" + str(snpCounts) + "\t" + str(insertionCounts) + "\t" + str(deletionCounts)
